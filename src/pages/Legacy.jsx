...
import vinhedos from "../assets/LegacyImages/vinhedo3.jpg"
        ...
        >
            ...
            <section className="relative h-[60vh] md:h-[70vh] flex items-center justify-center overflow-hidden">
                ...
                <div className="relative z-10 text-center px-6">
                    <motion.span
                        ...
                        className="text-[10px] uppercase text-stone-500 block mb-6 font-light"
                    >
                        Desde 2012
                    </motion.span>
            ...
            <section className="py-24 px-6 md:px-20 max-w-6xl mx-auto">
                <div className="grid md:grid-cols-2 gap-12 md:gap-20 items-center">
                    ...
                    {/* Container com proporção fixa para evitar deformação */}
                    <motion.div
                        initial={{ opacity: 0, y: 20 }}
                        whileInView={{ opacity: 1, y: 0 }}
                        transition={{ duration: 1.2 }}
                        className="relative aspect-[4/5] md:aspect-[3/4] overflow-hidden border border-white/5 p-2 bg-stone-900 order-1 md:order-2"
                    >
                        <img
                            src={vinhedos}
                            className="w-full h-full opacity-60 transition-all duration-1000 ease-in-out"
                    ...
                    <div className="flex flex-col gap-24 relative">
                        ...
                        >
                            ...
                            <p className="text-stone-500 text-xs leading-relaxed font-light">
                                Lançamento do nosso e-commerce e do primeiro Wine Bar próprio para atendimento exclusivo ao público.
                            </p>
                        </motion.div>
                        ...
                        >
                            ...
                            <p className="text-stone-500 text-xs leading-relaxed font-light">
                                Formatamos um novo modelo de negócios. Nascia a primeira franquia de Wine Bar do mercado brasileiro.
                            </p>
                        </motion.div>
                    </div>
                </div>
            ...
            <section className="py-32 px-6 md:px-20 max-w-7xl mx-auto">
                <div className="text-center mb-24">
                    ...
                    <h2 className="text-3xl md:text-5xl font-serif italic font-extralight text-stone-200 max-w-3xl mx-auto leading-tight">
                ...
                <div className="grid md:grid-cols-2 gap-8 md:gap-16">
                    <motion.div
                        ...
                        viewport={{ once: true }}
                        className="bg-white/[0.02] backdrop-blur-sm p-10 md:p-14 border border-white/5 rounded-sm flex flex-col items-center text-center"
                    >
                ...
                {/* PILARES */}
                <div className="mt-32 grid grid-cols-2 md:grid-cols-4 gap-12 md:gap-8">
                    {[
                        { icon: <Sparkles size={20} strokeWidth={1} />, text: "Produtos que inspiram" },
                        { icon: <Zap size={20} strokeWidth={1} />, text: "Publicidade Descomplicada" },
                        { icon: <GraduationCap size={20} strokeWidth={1} />, text: "Educação Sensorial" },
                        { icon: <Heart size={20} strokeWidth={1} />, text: "Foco no Protagonista" }
                    ].map((pilar, index) => (
                        <div key={index} className="flex flex-col items-center text-center gap-5 group">
                            <div className="text-stone-600 group-hover:text-stone-300 transition-all duration-700 transform group-hover:scale-110">
                                {pilar.icon}
                            </div>
                            <span className="text-[9px] uppercase tracking-[0.4em] text-stone-500 font-light leading-relaxed group-hover:text-stone-300 transition-colors">
                                {pilar.text}
                            </span>
                        </div>
                    ))}
